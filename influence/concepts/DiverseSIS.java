...
//Version of SIS that can interact with other concepts
...
public class DiverseSIS extends ExtendedConcept{
	...
	public DiverseSIS(int id, double recoverChance){
		super(id, "sis");
	...
	public void spread(Graph<MultiProbabilityNode, TypedWeightedEdge> graph, HashMap<Integer, Set<MultiProbabilityNode>> activatedNodes) {
		...
		for (MultiProbabilityNode currentNode : graph.getVertices()){
			if (!currentNode.isActivated(this)) {
				chance = 0;
